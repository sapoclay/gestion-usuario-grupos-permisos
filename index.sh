...
mostrar_menu() {
    ...
    echo "4. Programar tarea cron"
    echo "5. Crear usuario"
    echo "6. Crear grupo"
    echo "7. Asignar usuario a grupo"
    echo "8. Cambiar usuario de grupo"
    echo "9. Cambiar propietario y grupo propietario"
    echo "10. Borrar grupo"
    echo "11. Borrar usuario"
...
while [ $opc -ne 13 ]; do
    ...
    case $opc in
        ...
        4) programar_tarea_cron ;;  # Llama a la función para programar una tarea cron
        5) crear_usuario ;;  # Llama a la función para crear un usuario
        6) crear_grupo ;;  # Llama a la función para crear un grupo
        7) asignar_usuario_a_grupo ;;  # Llama a la función para asignar un usuario a un grupo
        8) cambiar_grupo_usuario ;;  # Llama a la función para cambiar el grupo primario de un usuario
        9) cambiar_propietario ;;  # Llama a la función para cambiar el usuario propietario y el grupo propietario
        10) borrar_grupo ;;  # Llama a la función para borrar un grupo
        11) borrar_usuario ;;  # Llama a la función para borrar un usuario y su carpeta home
